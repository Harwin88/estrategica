...
class carrusel extends React.Component {
  ...
  <Carousel   autoplay >
            <Row>
               <Col span="8">
                <Icon spin style={{ fontSize: '46px', color: '#f2f458' }} type="video-camera"  /><h6   class="tituloicon">Edicion de video</h6>
                </Col>
                <Col span="8">
                <Icon spin style={{ fontSize: '46px', color: '#52c41a' }} type="tags"  /><h6   class="tituloicon">Vende mas consigue nuevos clientes</h6>
                </Col>
                 <Col span="8">
                <Icon spin style={{ fontSize: '46px', color: '#08c' }} type="picture"  /><h6   class="tituloicon">Construcion de marca</h6>
              </Col>
          </Row>
          <Row>
              <Col span={8}>
